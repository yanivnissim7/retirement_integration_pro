...
def main():
    ...
    # חישוב הנסיגה: פטורים (נוכחי + עבר) כפול 1.35
    # הערה: אם הוותק מעל 32, המקדם נשאר 1.35. אין צורך ב-s_factor שמנטרל את השינוי.
    reduction_val = (actual_exempt_161 + past_exempt_grants) * 1.35
