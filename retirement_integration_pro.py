...
def main():
    ...
    <b>דיסקליימר:</b> דוח זה מהווה סימולציה בלבד ואינו מהווה ייעוץ פנסיוני או ייעוץ מס מחליף. הנתונים מבוססים על המידע שנמסר על ידי המשתמש ועל הוראות החוק ותקנות מס הכנסה (כולל תיקון 190). 
